...
class CodeOutputs
{
    ...
    static #Managed = class
    {
        ...
        RunOutput ()
        {
            ...
            srcWrap.style.textAlign = "right";
            const srcLink = document.createElement("a");
            srcLink.href = this.src;
            srcLink.target = "_blank";
            srcLink.rel = "noreferrer noopener";
            srcLink.append("Source↗");
            srcWrap.append(srcLink);
            
            this.#codeOutput.append(sizeElement[0], sizeElement[1], frameElement, srcWrap);
        ...
        RescaleTo (value)
        {
            ...
            switch (this.#currentScale)
            {
                case 0.125:
                    ...
                    this.#codeOutput.querySelector(".codedec").style.opacity = 0.5;
                    return;
                case 2:
                    this.#codeOutput.querySelector(".codeinc").onclick = () => { };
                    
                    this.#codeOutput.querySelector(".codeinc").style.cursor = "default";
                    this.#codeOutput.querySelector(".codeinc").style.opacity = 0.5;
                    return;
            }
            ...
            this.#codeOutput.querySelector(".codedec").style.opacity = 1;
            this.#codeOutput.querySelector(".codeinc").style.opacity = 1;
        }
