...
screenTrans.Start = function ()
{
    ...
    this.interval = setInterval(() => { this.ScanAnchors(); }, 50);
};
...
Menu.Toggle = function ()
{
    ...
    if (!this.enabled)
    {
        ...
        this.main.innerHTML += `<div id="menu"><div id="menuNav">${this.navData}</div><div id="menuSocials"><a href="${data.socials.youtube}" target="_blank" rel="noreferrer noopener"><img id="menuBtnYt" class="unselectable" src="${data.sprites.socials}"></a><a href="${data.socials.twitter}" target="_blank" rel="noreferrer noopener"><img id="menuBtnTwt" class="unselectable" src="${data.sprites.socials}"></a><a href="${data.socials.instagram}" target="_blank" rel="noreferrer noopener"><img id="menuBtnInsta" class="unselectable" src="${data.sprites.socials}"></a></div></div><hr id="menuOverlay">`;
